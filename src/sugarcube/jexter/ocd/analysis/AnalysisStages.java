...
public final class AnalysisStages {
    ...
    private static String page(OCDDocument doc, FontProfile fp, int pg) {
        ...
        // The page's own frame is the MEDIA box — that is what the SVG space is anchored on
        // (OCDPage#toSvg), and the viewer maps these boxes with the same flip it renders with. The
        // crop is a window over that frame, not a second coordinate system.
        JxRect eb = page.mediaBox();
