...
const RENDER_SOURCES = [
    ...
    { id: 'ocd',        label: 'OCD',        icon: 'box-select', vector: true, tip: 'The OCD model rendered as vector SVG \u2014 selectable text, crisp at any zoom' },
...
async function openFile(file) {
    ...
    if (!/\.pdf$/i.test(file.name) && file.type !== 'application/pdf') {
        toast('PDF Inspector opens PDF files \u2014 an OCD-EPUB belongs in Prism.', 'warning'); return;
    }
