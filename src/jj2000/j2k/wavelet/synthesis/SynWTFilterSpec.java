...
public class SynWTFilterSpec extends ModuleSpec
{
   ...
   *
   * <p>The horizontal analysis filters are returned in an array of SynWTFilter. Each element contains the horizontal filter for each resolution level starting
   ...
   * resolution level, then the last element is assumed to be repeated.</p>
   *
   ...
   *
   * <p>The vertical analysis filters are returned in an array of SynWTFilter. Each element contains the vertical filter for each resolution level starting with
   ...
   * level, then the last element is assumed to be repeated.</p>
   *
   * @param t The tile index, in raster scan order
   *
   * @param c The component index.
