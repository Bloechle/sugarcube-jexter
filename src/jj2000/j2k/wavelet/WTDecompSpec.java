...
/**
 * This class holds the decomposition type to be used in each part of the image; the default one, the component specific ones, the tile default ones and the
 * component-tile specific ones.
 *
 * <P>The decomposition type identifiers values are the same as in the codestream.
 *
 * <P>The hierarchy is:<br> - Tile and component specific decomposition<br> - Tile specific default decomposition<br> - Component main default decomposition<br>
...
public class WTDecompSpec
{
  ...
  /**
   * ID for the SPACL (as defined in JPEG 2000) wavelet tree decomposition (1 level of decomposition in the high bands and some specified number for the lowest
   * LL band): 0x02.
   */
  public final static int WT_DECOMP_SPACL = 2;
  /**
   * ID for the PACKET (as defined in JPEG 2000) wavelet tree decomposition (2 levels of decomposition in the high bands and some specified number for the
   * lowest LL band): 0x01.
   */
  ...
  /**
   * Sets the "component main default" decomposition type and number of levels for the specified component. Both 'dec' and 'lev' can not be negative at the same
   * time.
   *
   * @param n The component index
   *
   * @param dec The decomposition type. If negative then the main default is used.
   *
   * @param lev The number of levels. If negative then the main defaul is used.
   *
   *
   *
   */
  ...
  /**
   * Returns the type of specification for the decomposition in the specified component and tile. The specification type is one of: 'DEC_SPEC_MAIN_DEF',
   * 'DEC_SPEC_COMP_DEF', 'DEC_SPEC_TILE_DEF', 'DEC_SPEC_TILE_COMP'.
   *
   * <P>NOTE: The tile specific things are not supported yet
   *
   * @param n The component index
