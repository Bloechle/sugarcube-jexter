...
//      System.runFinalizersOnExit(true);
    ...
    int state[], int zc_lut[], boolean isterm)
  {
    ...
    // Upstream fix (jai-imageio-jpeg2000): (3 << bp) overflows into the sign bit at bp >= 30 and
    // the mask comes back negative. Same value for every smaller bit-plane, correct for the deep ones.
    int one = 1 << bp;
    setmask = one | (one >> 1);
