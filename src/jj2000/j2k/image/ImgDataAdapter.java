...
/**
 * This class provides a default implementation of the methods in the 'ImgData' interface. The default implementation is just to return the value of the source,
 * where the source is another 'ImgData' object.
 *
 * <p>This abstract class can be used to facilitate the development of other classes that implement 'ImgData'. For example a YCbCr color transform can inherit
 * from this class and all the trivial methods do not have to be re-implemented.</p>
 *
 * <p>If the default implementation of a method provided in this class does not suit a particular implementation of the 'ImgData' interface, the method can be
 * overridden to implement the proper behavior.</p>
 *
 * @see ImgData
 *
 */
