...
public class HeaderDecoder implements ProgressionType, Markers, StdEntropyCoderOptions
{
    ...
    int tpIdx) throws IOException
  {
    ...
    if (mainh)
    {
      ...
      if ((cstyle & SCOX_USE_SOP) != 0)
      {
        ...
        decSpec.sops.setDefault(Boolean.valueOf("true"));
        sopUsed = true;
        // Remove flag
        cstyle &= ~(SCOX_USE_SOP);
      }
        ...
        decSpec.sops.setDefault(Boolean.valueOf("false"));
    }
    else
    {
      ...
      {
        // SOP markers are used
        decSpec.sops.setTileDef(tileIdx, Boolean.valueOf("true"));
        sopUsed = true;
        // Remove flag
        cstyle &= ~(SCOX_USE_SOP);
      }
        ...
        // SOP markers are not used
        decSpec.sops.setTileDef(tileIdx, Boolean.valueOf("false"));
    }
    ...
    if (mainh)
      if ((cstyle & SCOX_USE_EPH) != 0)
      {
        ...
        decSpec.ephs.setDefault(Boolean.valueOf("true"));
        ephUsed = true;
        // Remove flag
        cstyle &= ~(SCOX_USE_EPH);
      }
        ...
        decSpec.ephs.setDefault(Boolean.valueOf("false"));
    else if ((cstyle & SCOX_USE_EPH) != 0)
    {
      // EPH markers are used
      decSpec.ephs.setTileDef(tileIdx, Boolean.valueOf("true"));
      ephUsed = true;
      // Remove flag
      cstyle &= ~(SCOX_USE_EPH);
    }
      ...
      // EPH markers are not used
      decSpec.ephs.setTileDef(tileIdx, Boolean.valueOf("false"));
  ...
  private void readPPM(DataInputStream ehs) throws IOException
  {
    ...
    if (pPMMarkerData == null)
    {
      ...
      decSpec.pphs.setDefault(Boolean.valueOf(true));
    }
    ...
    throws IOException
  {
    ...
    decSpec.pphs.setTileDef(tile, Boolean.valueOf(true));
  }
