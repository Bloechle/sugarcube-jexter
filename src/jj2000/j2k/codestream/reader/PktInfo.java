...
public class PktInfo
{
  ...
  public int cbLength;
  /**
   * The length of each terminated segment in the packet. The total is the same as 'cbLength'. It can be null if there is only one terminated segment, in which
   * case 'cbLength' holds the legth of that segment 
     *
   */
  public int segLengths[];
  /**
   * The number of truncation points that appear in this packet, and all previous packets, for this code-block. This is the number of passes that can be decoded
   * with the information in this packet and all previous ones. 
     *
   */
