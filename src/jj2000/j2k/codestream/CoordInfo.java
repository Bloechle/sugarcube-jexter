...
/**
 * This class is used to store the coordinates of objects such as code-blocks or precincts. As this is an abstract class, it cannot be used directly but derived
 * classes have been created for code-blocks and packets (CBlkCoordInfo and PrecCoordInfo).
 *
 * @see PrecCoordInfo
 * @see CBlkCoordInfo
 *
