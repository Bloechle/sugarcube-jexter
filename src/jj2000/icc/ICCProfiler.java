...
/**
 * This class provides ICC Profiling API for the jj2000.j2k imaging chain by implementing the BlkImgDataSrc interface, in particular the getCompData and
...
public class ICCProfiler extends ColorSpaceMapper
{
   ...
   * @return ICCMatrixBasedInputProfile for 3 component input and ICCMonochromeInputProfile for a 1 component source. Returns null if exceptions were
   * encountered.
   ...
   *
   * @param out Its coordinates and dimensions specify the area to return. If it contains a non-null data array, then it must have the correct dimensions. If it
