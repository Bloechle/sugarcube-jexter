...
public abstract class RestrictedICCProfile
{
    ...
    ICCXYZType rcolorant, ICCXYZType gcolorant, ICCXYZType bcolorant)
  {
    ...
    return MatrixBasedRestrictedProfile.createInstance(rcurve, gcurve, bcurve,
   ...
   * Component index
   */
  protected final static int GRAY = ICCProfile.GRAY;
  /**
   * Component index
   */
  protected final static int RED = ICCProfile.RED;
  /**
   * Component index
   */
  protected final static int GREEN = ICCProfile.GREEN;
  /**
   * Component index
   */
  protected final static int BLUE = ICCProfile.BLUE;
  /**
