...
public abstract class ICCProfile
{
  ...
  private static class BoxType extends java.util.Hashtable
  {
    ...
    {
      map.put(Integer.valueOf(type), desc);
    }
  ...
  public RestrictedICCProfile parse() throws ICCProfileInvalidException
  {
    ...
    ICCCurveType grayTag = (ICCCurveType) tags.get(Integer.valueOf(kdwGrayTRCTag));
    if (grayTag != null)
    ...
    ICCCurveType rTRCTag = (ICCCurveType) tags.get(Integer.valueOf(kdwRedTRCTag));


    if (rTRCTag != null)
    {
      ICCCurveType gTRCTag = (ICCCurveType) tags.get(Integer.valueOf(kdwGreenTRCTag));
      ICCCurveType bTRCTag = (ICCCurveType) tags.get(Integer.valueOf(kdwBlueTRCTag));
      ICCXYZType rColorantTag = (ICCXYZType) tags.get(Integer.valueOf(kdwRedColorantTag));
      ICCXYZType gColorantTag = (ICCXYZType) tags.get(Integer.valueOf(kdwGreenColorantTag));
      ICCXYZType bColorantTag = (ICCXYZType) tags.get(Integer.valueOf(kdwBlueColorantTag));
