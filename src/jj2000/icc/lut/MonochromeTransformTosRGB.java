 ...
 * table. When this transform is applied to an input DataBlk, an output data block is constructed by using the input samples as indices into the lookup table,
 * whose values are used to populate the output DataBlk.
 *
...
public class MonochromeTransformTosRGB
{
   ...
   * Transform parameter.
   */
  public final static double ksRGBShadowCutoff = 0.0031308;
  /**
   * Transform parameter.
   */
  public final static double ksRGBShadowSlope = 12.92;
  /**
   * Transform parameter.
   */
  public final static double ksRGB8ShadowSlope = (255 * ksRGBShadowSlope);
  /**
   * Transform parameter.
   */
  public final static double ksRGBExponent = (1.0 / 2.4);
  /**
   * Transform parameter.
   */
  public final static double ksRGB8ScaleAfterExp = 269.025;
  /**
   * Transform parameter.
   */
  public final static double ksRGB8ReduceAfterExp = 14.025;
